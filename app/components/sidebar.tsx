...
export default function Sidebar({ darkMode, setDarkMode }: SidebarProps) {
  ...
  const [isOpenMobile, setIsOpenMobile] = useState(false); // Estado para móvil
  ...
  return (
    <>
      ...
      {/* 3. ASIDE (SIDEBAR) */}
      <aside
        className={`fixed lg:relative top-0 right-0 h-screen z-[140] transition-all duration-700 border-l flex flex-col shadow-2xl lg:shadow-none ${
          // Desktop: Ancho dinámico | Móvil: Se oculta o muestra
      ...
      >
        {/* BOTÓN DE CONTRAER/EXPANDIR (Solo visible en Desktop) */}
        <button
        ...
        {/* LOGO O INDICADOR SUPERIOR EN MÓVIL */}
          ...
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Texto: Visible siempre en móvil, dinámico en desktop */}
                <span
